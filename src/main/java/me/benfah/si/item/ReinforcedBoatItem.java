...
public class ReinforcedBoatItem extends Item {

	

	public ReinforcedBoatItem(Settings settings) {
		super(settings);
	}
	...
	public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
		...
		if (hitResult.getType() == HitResult.Type.MISS) {
			...
			if (hitResult.getType() == HitResult.Type.BLOCK) {
				ReinforcedBoatEntity boatEntity = new ReinforcedBoatEntity(world, hitResult.getPos().x, hitResult.getPos().y,
						hitResult.getPos().z);
