package me.benfah.si.entity.renderer;

import me.benfah.si.entity.ReinforcedBoatEntity;
import me.benfah.si.entity.renderer.model.ReinforcedBoatEntityModel;
...
public class ReinforcedBoatEntityRenderer extends EntityRenderer<ReinforcedBoatEntity> {
   ...
   protected final ReinforcedBoatEntityModel model = new ReinforcedBoatEntityModel();

   public ReinforcedBoatEntityRenderer(EntityRenderDispatcher entityRenderDispatcher) {
      super(entityRenderDispatcher);
      this.shadowSize = 0.8F;
   }

   public void render(ReinforcedBoatEntity boatEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
      matrixStack.push();
   ...
   public Identifier getTexture(ReinforcedBoatEntity boatEntity) {
      return new Identifier("snapshotideas", "textures/entity/boat/netherite.png");
   }
}
