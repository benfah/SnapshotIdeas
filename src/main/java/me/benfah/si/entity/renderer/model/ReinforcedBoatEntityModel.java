package me.benfah.si.entity.renderer.model;
...
public class ReinforcedBoatEntityModel extends CompositeEntityModel<ReinforcedBoatEntity> {
   private final ModelPart[] paddles = new ModelPart[2];
   private final ModelPart bottom;
   private final ImmutableList<ModelPart> parts;

   public ReinforcedBoatEntityModel() {
   ...
   public void setAngles(ReinforcedBoatEntity boatEntity, float f, float g, float h, float i, float j) {
   ...
   protected void setPaddleAngle(ReinforcedBoatEntity boat, int paddle, float angle) {
